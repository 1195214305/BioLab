            ...
            <Link to="/" className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[var(--text-primary)] flex items-center justify-center">
                <svg viewBox="0 0 24 24" className="w-6 h-6" fill="var(--bg-primary)">
                  ...
                  <path d="M9 8h6M9 12h6M9 16h6" stroke="var(--bg-primary)" strokeWidth="1.5"/>
                </svg>
              </div>
              <div className="hidden sm:block">
                <h1 className="text-xl font-bold text-[var(--text-primary)]">BioLab</h1>
                <p className="text-xs text-[var(--text-tertiary)]">高中生物知识系统</p>
              </div>
            </Link>
